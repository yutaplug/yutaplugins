...
import xyz.wingio.plugins.MarkdownFix;
...
public final class PluginSettings extends SettingsPage {
    ...
    private MarkdownFix plugin;
    private int p = DimenUtils.dpToPx(16);
    
    public PluginSettings(MarkdownFix plugin) {
        this.plugin = plugin;
    ...
    public void onViewBound(View view) {
        ...
        setActionBarTitle("MarkdownFix Settings");
        setPadding(p);
        ...
        info.setText(MDUtils.render("**Currently supports:**\n\n" +
                ...
                "- **Plugin Settings** (ac://[Plugin Name], *ex. ac://MarkdownFix*)\n" +
                "- **Colors** *ex #1f8b4c*\n" +
