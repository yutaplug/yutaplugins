...
public class DiscordAPI {
    ...
    public static String uploadFile(File file, long channel, String extension) {
        if (file == null || !file.isFile() || file.length() <= 0) {
            throw new IllegalArgumentException("Cannot upload an empty voice recording");
        }
        ...
        try {
            ...
            var body = new AttachmentBody(file.getName(), file.length());
    ...
    public static String sendVoiceMessage(String fileName, float duration, String waveform, long channelID, String extension) {
        return sendVoiceMessage(fileName, duration, waveform, channelID, extension, null);
    }

    public static String sendVoiceMessage(String fileName, float duration, String waveform, long channelID, String extension, VoiceMessageBody.MessageReference messageReference) {
        try {
